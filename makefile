...
CFLAGS= -Wall -I/usr/local/include -I/usr/local -I/opt/opencv/include/opencv4/opencv2 -I/opt/opencv/include/opencv4 -I$(BOOSTROOT) -I$(IDIR) -I${PYTHONINCLUDE} -std=gnu++14 -c -D_USE_MATH_DEFINES -O3 -fopenmp
...
LDFLAGS=-L/usr/local/lib -L/use/local -L/opt/opencv/lib64 -lopencv_highgui -lopencv_flann -lopencv_imgproc -lopencv_core -lm -lfftw3 -fopenmp 
